      ...
      <div className="b-header__logo">
        ...
        <div className="flex justify-center relative mb-12">
          <ul className="text-xl  m-auto  inline-flex space-x-3  bg-pale">
            <li className="border-2 border-dark  relative z-10 bg-pale">
            <a href="/sublime-text" className=" px-6 py-3 block hover:bg-darkerGray"><span class="b-menu__app-icon sublime-text"></span>Sublime Text</a>
            </li>
            <li className="border-2 border-dark  relative z-10 bg-pale">
            <a href="/vscode" className="block  px-6 py-3 hover:bg-darkerGray"><span class="b-menu__app-icon vscode"></span>VS Code</a>
            </li>
          </ul>
